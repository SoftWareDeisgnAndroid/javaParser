...
class TimeTable{
	...
	public void crawl(String code) throws Exception{
		...
		for (Element content: contents) {
			...
			*/
			...
			department = info.get(2).text().trim();
			...
			this.sendQuery(class_number, grade, class_name, parser.next(),parser.next(),class_time,department);
			if (info.size() == 17) { 
	...
	private void sendQuery(String lecturenumber,String grade, String lecturename,String lectureBuilding,String lectureRoom,String class_time,String department) {
		try {
